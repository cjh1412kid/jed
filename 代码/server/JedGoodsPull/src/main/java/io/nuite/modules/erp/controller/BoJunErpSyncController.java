...
public class BoJunErpSyncController extends io.nuite.modules.order_platform_app.controller.BaseController {
    private Logger logger = LoggerFactory.getLogger(getClass());
    
    @Autowired
    private io.nuite.modules.erp.service.ErpSeasonSyncService erpSeasonSyncService;
    
    @Autowired
    private io.nuite.modules.erp.service.ErpGoodsSyncService erpGoodsSyncService;
	
    @Autowired
    private io.nuite.modules.erp.service.ErpColorService erpColorService;
    
    @Autowired
    private io.nuite.modules.erp.service.ErpShoesDataSyncService erpShoesDataSyncService;
    
    @Autowired
    private io.nuite.modules.erp.service.ErpShopService erpShopService;
