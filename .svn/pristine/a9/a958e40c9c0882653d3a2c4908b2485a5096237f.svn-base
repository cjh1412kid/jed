...
public interface OrderProductManagementService {
     ...
     * 货品的列表
     */
    PageUtils getGoodsList(Page page, Integer companySeq, Map<String, Object> params);
     ...
     * @return
     */
    Page listGoods(Page page, Integer companySeq);
     ...
     * 获取当前用户波次列表 按年分类
     */
    Map<String, List<GoodsPeriodEntity>> getUserPeriods(BaseUserEntity userEntity);
    
    /**
     * 获取当前用户的所有鞋子分类
     */
    List<GoodsCategoryEntity> getUserCategory(BaseUserEntity userEntity);
	...
	void setMainpush(Integer shoesSeq, Integer isMainpush);

	void setNewest(Integer shoesSeq, Integer isNewest);
