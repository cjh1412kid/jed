...
public interface ShoesInfoService extends IService<ShoesInfoEntity> {
	...
	List<Map<String, Object>> getHqAndShopShoesList(List<Integer> satisfyShoesSeqs, Integer orderBy, Integer orderDir, Integer start,
                                                    Integer num);
	
	 Page<Map<String, Object>> getPage(List<Integer> satisfyShoesSeqs, Integer orderBy, Integer orderDir, Integer start,
                                       Integer num);
	

	List<Map<String, Object>> getHqAndShopShoesListOnSaleTime(List<Integer> satisfyShoesSeqs, Date saleTimeStart, Date saleTimeEnd,
	 ...
	 Page<Map<String, Object>> getPage(List<Integer> satisfyShoesSeqs, Date saleTimeStart, Date saleTimeEnd,
                                       Integer stockMinNum, Integer stockMaxNum, Integer orderBy, Integer orderDir, Integer start, Integer num, List<Integer> shopSeqList);
	
	List<Map<String, Object>> getShopShoesList(List<Object> shopSeqList, Integer shopSeq, List<Integer> satisfyShoesSeqs, Integer orderBy, Integer orderDir,
                                               Integer start, Integer num);
	
	 Page<Map<String, Object>> getPage(List<Object> shopSeqList, Integer shopSeq, List<Integer> satisfyShoesSeqs, Integer orderBy, Integer orderDir,
                                       Integer start, Integer num);
	
	
	List<Map<String, Object>> getShopShoesListOnSaleTime(List<Object> shopSeqList, Integer shopSeq, List<Integer> satisfyShoesSeqs, Date saleTimeStart,
                                                         Date saleTimeEnd, Integer stockMinNum, Integer stockMaxNum, Integer orderBy, Integer orderDir, Integer start, Integer num);
	
	 Page<Map<String, Object>> getPage(List<Object> shopSeqList, Integer shopSeq, List<Integer> satisfyShoesSeqs, Date saleTimeStart,
                                       Date saleTimeEnd, Integer stockMinNum, Integer stockMaxNum, Integer orderBy, Integer orderDir, Integer start, Integer num);
