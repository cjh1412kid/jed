...
//			HAVING MIN (UpdateTime) >= '2019-12-17 00:00:00'
     ...
     */
	@Override
	public Page<Map<String, Object>> getHqAndShopShoesListOnSaleTime(Integer requestFromType, List<Integer> satisfyShoesSeqs, Date saleTimeStart,
        ...
        if(requestFromType == 0) { //app查询时不用计算总数，提高查询速度
        	page.setSearchCount(false);
        }
        
        String shoesSeqs = Joiner.on(",").join(satisfyShoesSeqs);
        
		List<Map<String, Object>> list = shoesInfoDao.getHqAndShopShoesListOnSaleTime(page, requestFromType, shoesSeqs, saleTimeStart, saleTimeEnd, stockMinNum, stockMaxNum, orderBy, orderDir,shopSeqList);
	 ...
	 */
	@Override
	public Page<Map<String, Object>> getShopShoesListOnSaleTime(Integer requestFromType, List<Object> shopSeqList,Integer shopSeq, List<Integer> satisfyShoesSeqs, Date saleTimeStart,
		...
		List<Map<String, Object>> list = shoesInfoDao.getShopShoesListOnSaleTime(page, requestFromType, shopSeqList, shopSeq, shoesSeqs, saleTimeStart, saleTimeEnd, stockMinNum, stockMaxNum, orderBy, orderDir);
		page.setRecords(list);
		return page;
	}
