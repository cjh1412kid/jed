...
public class OkHttpUtil{
    ...
    public OkHttpUtil(OkHttpClient  okHttpClient) {
    	System.out.println("############################ OkHttpUtil  okHttpClient:" + okHttpClient);
    ...
    public static String get(String url, Map<String, String> queries) {
        ...
        try { 
            ...
            if (response.isSuccessful()) {
                logger.info("okhttp3 get success >> code = {},response = {}", code, response);
    ...
    public static String post(String url, Map<String, String> params) {
        ...
        try { 
            ...
            int code = response.code();
            if (response.isSuccessful()) {
                logger.info("okhttp3 post success >> code = {},response = {}", code, response);
                return response.body().string();
            }
        } catch (Exception e) {
    ...
    public static String getForHeader(String url, Map<String, String> queries, Map<String, String> headers) {
        ...
        try { 
            ...
            int code = response.code();
            if (response.isSuccessful()) {
                logger.info("okhttp3 getForHeader success >> code = {},response = {}", code, response);
                return response.body().string();
            }
        } catch (Exception e) {
            logger.error("okhttp3 getForHeader error >> ex = {}", ExceptionUtils.getStackTrace(e));
        } finally {
            if (response != null) {
                response.close();
            }
    ...
    public static String postJson(String url, String jsonParams) {
        ...
        try { 
            ...
            int code = response.code();
            if (response.isSuccessful()) {
                logger.info("okhttp3 postJson success >> code = {},response = {}", code, response);
                return response.body().string();
            }
        } catch (Exception e) {
            logger.error("okhttp3 postJson error >> ex = {}", ExceptionUtils.getStackTrace(e));
        } finally {
            if (response != null) {
                response.close();
            }
    ...
    public static String postXml(String url, String xml) {
        ...
        try { 
            ...
            int code = response.code();
            if (response.isSuccessful()) {
                logger.info("okhttp3 postXml success >> code = {},response = {}", code, response);
                return response.body().string();
            }
        } catch (Exception e) {
            logger.error("okhttp3 postXml error >> ex = {}", ExceptionUtils.getStackTrace(e));
        } finally {
            if (response != null) {
                response.close();
            }
