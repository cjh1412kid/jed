...
/**
 * @description: 零售中间表实体类
 * @author: jxj
 * @create: 2019-11-13 18:28
 */
@Data
@TableName(DatabaseNames.SR_ORDER_PLATFORM+"YHSR_OP_ShoesData_Daily_Detail_Copy")
public class ShoesDataDailyDetailCopyEntity implements Serializable {
	...
	/**
	 * 对应的erp数据类型 0：总仓进货 1：仓出店 2：店退仓  3：销售
	 */
