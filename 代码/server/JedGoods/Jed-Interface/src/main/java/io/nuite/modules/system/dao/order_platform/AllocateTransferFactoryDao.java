...
@Mapper
public interface AllocateTransferFactoryDao extends BaseMapper<AllocateTransferFactoryEntity>{
	...
	List<Map<String, Object>>  getAllShoes(@Param("startDate")String startDate,@Param("endDate")String endDate,@Param("goodId")String goodId,Page page,@Param("companySeq")Integer companySeq);
